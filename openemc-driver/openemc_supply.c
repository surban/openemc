...
#define OPENEMC_POWER_SUPPLY_PS2 2
#define OPENEMC_POWER_SUPPLY_USB_SDP 3
#define OPENEMC_POWER_SUPPLY_USB_DCP 4
#define OPENEMC_POWER_SUPPLY_USB_CDP 5
#define OPENEMC_POWER_SUPPLY_CC_PINS_5V_1500MA 6
#define OPENEMC_POWER_SUPPLY_CC_PINS_5V_3000MA 7
#define OPENEMC_POWER_SUPPLY_PDO_CONTRACT 8
#define OPENEMC_POWER_SUPPLY_NEGOTIATING 9
