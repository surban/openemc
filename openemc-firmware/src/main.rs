...
/// Firmware copyright.
static COPYRIGHT: &[u8] = b"(c) 2022-2026 Sebastian Urban <surban@surban.net> license: GNU GPL version 3";
    ...
    fn init(mut cx: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        (
            Shared {
                ...
                adc_buf: None,
                power_supply: None,
                power_supply_connect_data: !board.power_mode().is_full(),
    ...
    fn charge_led(cx: charge_led::Context) {
        (cx.shared.battery, cx.shared.power_supply, cx.shared.board, cx.shared.undervoltage_power_off).lock(
            |battery, power_supply, board, undervoltage_power_off| {
                ...
                let grace_period: Duration = 20u64.secs();
                let grace = cx
                    .local
                    .supplying_since
